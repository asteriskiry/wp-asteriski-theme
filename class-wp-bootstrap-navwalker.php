	...
	class thebis_wp_bootstrap_navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$classes = array( 'sub-menu' );
				...
				$classes = array( 'sub-menu primary_sub-menus' );
			}
			/**
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children) {
				...
				$atts['class']         = 'mobile-menu-toggle primary-mobile-menu-toggle';
			...
			*/
			...
			// 	$item_output .=' <span class="fa fa-angle-down" aria-hidden="true"></span>';
			// }
			// if ( $args->has_children && $depth >= 1) {
			// 	$item_output .=' <span class="fa fa-angle-down" aria-hidden="true"></span>';
			// }
